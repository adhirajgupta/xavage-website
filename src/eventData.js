import image1 from './screens/LandingScreen/Bkg-Images/DealNoDeal.png';
import image2 from './screens/LandingScreen/Bkg-Images/Courting.png';
import image3 from './screens/LandingScreen/Bkg-Images/Ready.png';
import image4 from './screens/LandingScreen/Bkg-Images/Trojan.png';
import image5 from './screens/LandingScreen/Bkg-Images/CapitalConquest.png';
import image6 from './screens/LandingScreen/Bkg-Images/Clash.png';
import image7 from './screens/LandingScreen/Bkg-Images/Deal.png';
...
const eventData = [
  ...
  },
  {
    ...
    description: "Trojans tank will be a replica of Shark Tank wherein participants will be pre-assigned a industry and the participants will be tasked to create an innovative pitch for a unique product in order to raise money for investment purposes. HOD’s will be in charge of grading and scoring the pitch depending on how unique and how applicable it is to our current real life scenarios.",
    rules: "rules######",
    prizes: "prizes######",
    image: image4,
  },
